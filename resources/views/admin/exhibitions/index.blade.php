    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span>@lang('app.Exhibitions') </span> </h5>
            </div>
                        ...
                        <tbody>
                            @foreach($items as $each)
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($each->user))
                                            <a href="{{ asset('admin/users/update/'. $each->user->id) }}">{{ $each->user->firstname }} {{ $each->user->lastname }}</a>
                                    ...
                                    <td class="text-center table-icons">
                                        <ul class="list-group list-group-horizontal icons-list">
                                            <li class="list-group-item"><a class="text-primary" href="{{ asset('admin/exhibitions/update/'. $each->id ) }}"><i class="icon-pencil7"></i></a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{ asset('admin/exhibitions/delete') }}" id="delete-form" >
                        @csrf
