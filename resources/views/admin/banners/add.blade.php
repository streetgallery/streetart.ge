        ...
        var CKEditor = function() {
            ...
            var _componentCKEditor = function() {
                ...
                CKEDITOR.replace('description', {
                    height: 237,
                    filebrowserUploadUrl: "{{ asset('upload-article-content?item_id=1' ) }}&_token={{ csrf_token() }}",
    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span>@lang('app.Add_Banner') </span> </h5>
            </div>
        </div>
    ...
    <div class="content ">
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="itemForm" action="{{ asset('admin/banners/add') }}" autocomplete="off">
                            @csrf
