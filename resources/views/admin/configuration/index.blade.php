    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span><i class="icon-cog3"></i> @lang('app.Configuration') </span> </h5>
            </div>
    ...
    <div class="content ">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form method="post"  action="{{ asset('admin/configuration/'. $item->id) }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>@lang('app.Logo') svg</label>
                                <textarea name="logo" class="form-control" id="content" rows="4" cols="4">{{ $item->logo }}</textarea>
                                @if ($errors->has('logo'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="bodystart" class="form-control" id="content" rows="4" cols="4">{{ $item->bodystart }}</textarea>
                                @if ($errors->has('bodystart'))
                                    <span class="form-text text-danger">{{ $errors->first('bodystart') }}</span>
                                @endif
                            </div>

                            <div class="form-check form-check-switchery switchery-sm mt-1 mr-auto">
                                <label class="form-check-label">
                                    <input type="hidden" name="site_off" checked value="0">
                                    <input type="checkbox" name="site_off" @if($item->site_off == 1 ) checked @endif value="1" class="form-switchery" >
                                    @lang('app.Site Off')
                                </label>
                            </div>

                            <button type="submit" class="btn btn-primary mt-4">@lang('app.Submit') <i class="icon-paperplane ml-2"></i></button>
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="#" data-toggle="modal" data-target="#modal_blog" class="btn btn-primary">@lang('app.Blog Cover') <i class="icon-stack-picture ml-2"></i></a>
                        <a href="#" data-toggle="modal" data-target="#modal_event" class="btn btn-primary">@lang('app.Event Cover') <i class="icon-stack-picture ml-2"></i></a>
                    </div>
                </div>
            </div>
...
@section('bodyend')
     <div id="modal_blog" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('app.Blog Cover')</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <iframe src="{{ asset('admin/blog_cover') }}" style="border:0px #ffffff none;" name="myiFrame" scrolling="yes" frameborder="1" marginheight="0px" marginwidth="0px" height="600px" width="100%" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>

     <div id="modal_event" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('app.Event Cover')</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <iframe src="{{ asset('admin/event_cover') }}" style="border:0px #ffffff none;" name="myiFrame" scrolling="yes" frameborder="1" marginheight="0px" marginwidth="0px" height="600px" width="100%" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
