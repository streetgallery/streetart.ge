    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span>@lang('app.Update_City') </span> </h5>
            </div>
        </div>
    ...
    <div class="content ">
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="itemForm" action="{{ asset('admin/cities/update/'. $item->id) }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="country_id" id="country_id" data-placeholder="@lang('app.Select')" class="form-control select2" data-fouc>
                                    ...
                                    @foreach($countries as $each)
                                        @if(App::isLocale('ka'))
                                            <option @if( $item->state->country_id == $each->id) selected @endif value="{{ $each->id }}">{{ $each->name }}</option>
                                        @endif
                                        @if(App::isLocale('en'))
