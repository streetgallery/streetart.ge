    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span>@lang('app.Add_Slide') </span> </h5>
            </div>
        </div>
    ...
    <div class="content ">
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="itemForm" action="{{ asset('admin/slides/add') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="content-ka">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control @if ($errors->has('description')) border-danger @endif" rows="4" cols="4">{{ old('description') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if ($errors->has('button')) border-danger @endif" value="{{ old('button') }}" name="button">
                                ...
                                <div class="tab-pane fade" id="content-en">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_en" class="form-control @if ($errors->has('description_en')) border-danger @endif" rows="4" cols="4">{{ old('description_en') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if ($errors->has('button_en')) border-danger @endif" value="{{ old('button_en') }}" name="button_en">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="d-inline-block">
                                    <input type="text" class="form-control colorpicker-show-input" name="color" data-preferred-format="rgb" value="{{ old('color') }}" data-fouc>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="d-inline-block">
                                    <input type="text" class="form-control colorpicker-show-input" name="bg_color" data-preferred-format="rgb"  value="{{ old('bg_color') }}" data-fouc>
                                </div>
                            </div>
