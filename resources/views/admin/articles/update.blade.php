                ...
                Dropzone.options.dropzoneMultiple = {
                    ...
                    init:function() {
                        ...
                        itemImages.forEach(function(image_filename) {
                            ...
                            myDropzone.emit("thumbnail", file,  '{{ asset('files/articles/'. $item->id .'/small/') }}'   +"/"+image_filename);
                        ...
                        this.on("removedfile", function(file) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '{{ asset('article/delete-image') }}',
        ...
        var CKEditor = function() {
            ...
            var _componentCKEditor = function() {
                ...
                CKEDITOR.replace('content', {
                    height: 237,
                    filebrowserUploadUrl: "{{ asset('upload-article-content?item_id='. $item->id ) }}&_token={{ csrf_token() }}",
                    filebrowserUploadMethod: 'form'
                });

                CKEDITOR.replace('content_en', {
                    height: 237,
                    filebrowserUploadUrl: "{{ asset('upload-article-content?item_id=21'. $item->id ) }}&_token={{ csrf_token() }}",
                    filebrowserUploadMethod: 'form'
                });
...
@section('content')
    ...
    <div class="page-header mt-3">
        <div class="page-header-content header-elements-inline">
            <div class="page-title py-1 d-flex">
                <h5><span>@lang('app.Update_Article') </span> </h5>
            </div>
        </div>
    ...
    <div class="content ">
        ...
        <form method="post" id="itemForm" action="{{ asset('admin/articles/update/'. $item->id) }}" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-xl-8">
                    <div class="card">
            ...
            <div class="col-xl-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => route('upload-article'), 'class' => 'dropzone', 'files'=>true, 'id'=>'dropzone_multiple']) !!}
