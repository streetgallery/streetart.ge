...
@section('content')
                    ...
                    <div class="location-single">
                        @if(isset($item->images[0]->medium))
                            <div class="location-desc">
                                <img src="{{ asset($item->images[0]->medium) }}"  alt="">
                        ...
                        <div id="inner-location-map" class="location-map"></div>
    ...
    <section class="artists-page pt-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <ol class="artup-list" >
                        <li class="mb-1">
                            <a href="#div" class="home-title new"> @lang('site.ARCHIVE') </a>
                        </li>

                    </ol>

                     <ol class="artup-list mb-5 mt-4" id="grid">
...
@section('bodyend')
    ...
    <script type="text/javascript">
        ...
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('inner-location-map'), {
                zoom: 17,
